<template>
  <div id="list">
    ...
    <div
      ...
      :class="{ selected: selectedDiscussion == discussion.id }"
      v-for="discussion in discussions"
      :key="discussion.id"
      @click="
        selectDiscussion(discussion.id);
        makeDiscussionMessagesSeen(discussion.id, discussion.couple);
      "
    >
